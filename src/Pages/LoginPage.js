...
const LoginPage = () => {
    ...
    const userName = localStorage.getItem("email") 
     ? localStorage.getItem("email") : "adimin@adimin.com";

     const userPassword = localStorage.getItem("password")
      ? localStorage.getItem("password") : "adimin" ;

      const userconfromPassword = localStorage.getItem("conformPassword")
      ? localStorage.getItem("password") : "adimin";
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
   if(email === userName && password === userPassword && conformPassword === userPassword){
